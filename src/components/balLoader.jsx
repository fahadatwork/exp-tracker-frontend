...
export default function BalLoader() {
  return (
    
<div role="status" className="w-[600px] h-[410px] p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
